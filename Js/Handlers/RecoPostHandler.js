...
var GetRecoPostByDesc = () =>{
            ...
            recoList.push(new RecoPost("What is a Dictionary in C# akt","https://cseatoz.blogspot.com/2020/10/c-dictionary.html"));
...
var BindInsideTheme = (recoList) => {
            document.getElementById("recommended_label").classList.add('justify-content-space-between');
            console.log(recoList);
            var rcl = "<ul style='margin:50px 25px 25px 25px; '>";
            for (let i=0; i<recoList.length; i++) {
                 rcl += "<a href=" + recoList[i].Link  + " style='color: #00ff00;'><li>" + recoList[i].Title + "</li></a>";
             }
